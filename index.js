...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayProducts(products) {
        ...
        products.forEach(product => {
            ...
            detailsLink.className = "btn btn-primary mx-4 bg-transparent border-primary text-primary btn-hover";
            ...
            editLink.className = "btn btn-secondary bg-transparent text-secondary border-secondary btn-hover";
