...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayProducts(products) {
        ...
        products.forEach(product => {
            ...
            cardPrice.innerHTML = `<strong>Prezzo:</strong> €${product.price}`;
            ...
            detailsLink.innerHTML = `Scopri di più <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-index text-primary" viewBox="0 0 16 16">
            ...
            editLink.innerHTML = `Modifica <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="secondary" class="bi bi-pencil-square text-secondary" viewBox="0 0 16 16">
